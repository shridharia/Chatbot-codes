...
// ImpactAnalyticsChatbot class
       class ImpactAnalyticsChatbot {
           constructor() {
               ...
               this.userQueryCount = 0; // Track number of user queries submitted
               this.init();
           }
           resetChat() {
               this.resetSessionMemory();
               this.userQueryCount = 0; // Reset query count
               if (this.chatArea) {
	...
	async resetSessionMemory() {
        try {
           ...
           async sendMessage() {
               ...
               // Increment user query count and trigger blinking if needed
               this.userQueryCount = (this.userQueryCount || 0) + 1;
               if (this.userQueryCount === 4) {
                   const suggestionBtns = document.querySelectorAll('.ia-suggestion-btn');
                   suggestionBtns.forEach(btn => btn.classList.add('blink-suggestion'));
               }
           ...
           addMessage(content, type) {
               ...
               if (type === 'bot') {
                   ...
                   avatarDiv.innerHTML = '<img src="https://www.impactanalytics.co/wp-content/uploads/2025/10/impact-chat2.png" alt="IA Bot" style="width:26px;height:26px;" />';
           ...
           showTypingIndicator() {
               ...
               typingDiv.innerHTML = `
                   <img src="https://www.impactanalytics.co/wp-content/uploads/2025/10/impact-chat2.png" alt="IA Bot" style="width:26px;height:26px;" />
                   <div class="ia-message-content">
